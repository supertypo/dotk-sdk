...
export default tseslint.config(
  ...
  ...tseslint.configs.stylisticTypeChecked,
  {
    ...
    rules: {
      ...
      // A discriminated union's arms are type aliases, so an answer passes wherever a plain
      // object type is accepted. An interface has no index signature and does not.
